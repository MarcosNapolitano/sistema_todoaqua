...
def generar_presupuesto_todo_fugas(cliente: "Cliente", presupuesto: "Presupuesto_Todo_Fugas") -> True:
    ...
    document.paragraphs[11].add_run(
        f" {cliente.localidad}"
        + " " * 10
        + f"CP: {cliente.cp}"
        + " " * 10
    ...
    match presupuesto.tipo_tuberia:

        # to do: hay que mejorar esto luego
        case "domestica":
    ...
    document.paragraphs[40].add_run(
