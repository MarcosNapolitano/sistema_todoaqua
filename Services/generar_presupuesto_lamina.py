...
def generar_presupuesto_lamina(cliente: object, presupuesto: object) -> True: 
...
def modelo(document: object, presupuesto: object) -> None:
	
	document.paragraphs[17].add_run(f" {presupuesto.modelo}").italic = True

	return

def primera_partida(document: object, presupuesto: object) -> None:
	...
	document.paragraphs[25].add_run(f"                  {presupuesto.metros}m2").bold = True
	document.paragraphs[25].runs[-1].font.size = Pt(14)

	document.paragraphs[27].add_run(f" {presupuesto.tarifa * presupuesto.metros} €").bold = True
...
def segunda_partida(document: object, presupuesto: object) -> None:
	...
	if presupuesto.impulsion:
		...
		temp.add_run(f"{presupuesto.impulsion_precio} € und. x{presupuesto.impulsion} --------------------------------> {presupuesto.impulsion_precio * presupuesto.impulsion} €")
	...
	if presupuesto.barrefondo:
		...
		temp.add_run("                     ").underline = True
		temp.add_run(f"{presupuesto.barrefondo_precio} € und. x{presupuesto.barrefondo} --------------------------------> {presupuesto.barrefondo_precio * presupuesto.barrefondo} €")
		temp.style = 'List Paragraph'
		temp.runs[0].font.bold = True
		temp.runs[0].font.size = Pt(12)
		temp.runs[1].font.bold = True
	...
	if presupuesto.skimmers:
		...
		temp.add_run("                                      ").underline = True
		temp.add_run(f"{presupuesto.skimmers_precio} € und. x{presupuesto.skimmers} --------------------------------> {presupuesto.skimmers_precio * presupuesto.skimmers} €")
		temp.style = 'List Paragraph'
		temp.runs[0].font.bold = True
		temp.runs[0].font.size = Pt(12)
		temp.runs[1].font.bold = True
	...
	if presupuesto.sumidero:
		...
		temp.add_run("                    ").underline = True
		temp.add_run(f"{presupuesto.sumidero_precio} € und. x{presupuesto.sumidero} --------------------------------> {presupuesto.sumidero_precio * presupuesto.sumidero} €")
		temp.style = 'List Paragraph'
		temp.runs[0].font.bold = True
		temp.runs[0].font.size = Pt(12)
		temp.runs[1].font.bold = True
	...
	if presupuesto.sumidero_grande:
		...
		temp.add_run(f"•{chr(9)}Sumidero de Fondo")
		temp.add_run("                    ").underline = True
		temp.add_run(f"{presupuesto.sumidero_grande_precio} € und. x{presupuesto.sumidero_grande} --------------------------------> {presupuesto.sumidero_grande_precio * presupuesto.sumidero_grande} €")
		temp.style = 'List Paragraph'
		temp.runs[0].font.bold = True
		temp.runs[0].font.size = Pt(12)
		temp.runs[1].font.bold = True
	...
	if presupuesto.nicho:
		...
		temp.add_run("                                ").underline = True
		temp.add_run(f"{presupuesto.nicho_precio} € und. x{presupuesto.nicho} --------------------------------> {presupuesto.nicho_precio * presupuesto.nicho} €")
		temp.style = 'List Paragraph'
		temp.runs[0].font.bold = True
		temp.runs[0].font.size = Pt(12)
		temp.runs[1].font.bold = True
...
def tercera_partida(document: object, presupuesto: object) -> None:
	...
	temp.add_run("                                ").underline = True
	temp.add_run(f"{presupuesto.otros_precio} € und. x{presupuesto.otros} --------------------------------> {presupuesto.otros_precio * presupuesto.otros}€")
...
def totales(document: object, presupuesto: object) -> None:
	...
	temp.add_run(f"{floor(((presupuesto.total - presupuesto.total/1.21)*100)/100.0)}€").bold = True
	temp.runs[-1].font.size = Pt(14)
...
def porcentajes(document: object, presupuesto: object) -> None:

	# por alguna razon esto dejo de funcionar bien
	temp = document.paragraphs[74]
	temp.runs[4].text = str(floor((presupuesto.total * .8*100)/100.0))
